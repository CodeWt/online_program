$(function () {
    ...
    getHistoryCode(window.sessionStorage.getItem("userId"));
})
function searchBtn() {
    var val = $('#kw').val();
            ...
            if (obj.data.length>0){
                ...
                for (var i=0;i<obj.data.length;i++){
                    var str = "<div id='"+obj.data[i].codeId+"'>" +
                        ...
                        "        <images src=\"images/del1.png\" id=\"del\" onclick='delcode(\""+obj.data[i].codeId+"\")'><a onclick='delcode(\""+obj.data[i].codeId+"\")'>删除</a></p>\n" +
                        "    <div id=\"line\"></div><div>";
                    $('.search').after(str);
                }
            }else {
                ...
                $('.search').after("<h1>God help those who help themselves .</h1>\n" +
                    "    <images src=\"images/wdm.jpg\" id=\"hwc\">");
            }
        }
    }
}
